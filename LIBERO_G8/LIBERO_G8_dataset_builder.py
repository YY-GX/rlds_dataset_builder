...
group_splits = {
    "Group1": [22, 13, 42, 7, 39, 62, 37, 84, 51, 31, 79, 18, 10, 52, 3, 40, 45, 64, 0, 72],
    "Group2": [26, 64, 18, 83, 4, 60, 71, 15, 45, 66, 7, 19, 88, 29, 67, 86, 61, 63, 56, 25],
    "Group3": [39, 22, 61, 84, 49, 89, 51, 47, 6, 85, 0, 82, 50, 26, 57, 23, 17, 74, 83, 55],
    "Group4": [39, 49, 20, 61, 31, 89, 13, 6, 67, 1, 41, 57, 30, 80, 77, 5, 23, 54, 55, 38],
    "Group5": [22, 13, 42, 7, 39, 40, 45, 64, 0, 72],
    "Group6": [22, 13, 45, 64, 0],
    "Group7": [0, 80, 34, 3, 10, 81, 21, 1, 19, 51],
    "Group8": [81, 21, 1, 19, 51],
}
...
demos_file = list(demos_file[group_splits['Group8']])
...
class LiberoG8(MultiThreadedDatasetBuilder):
