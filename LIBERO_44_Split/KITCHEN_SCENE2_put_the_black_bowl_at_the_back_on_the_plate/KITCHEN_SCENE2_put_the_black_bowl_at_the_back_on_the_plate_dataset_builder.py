...
class kitchenScene2PutTheBlackBowlAtTheBackOnThePlateDatasetBuilder(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            ...
            "train": glob.glob("/mnt/arc/yygx/pkgs_baselines/LIBERO/libero/datasets/libero_90_openvla_no_noops/KITCHEN_SCENE2_put_the_black_bowl_at_the_back_on_the_plate_demo.hdf5"),
        }
