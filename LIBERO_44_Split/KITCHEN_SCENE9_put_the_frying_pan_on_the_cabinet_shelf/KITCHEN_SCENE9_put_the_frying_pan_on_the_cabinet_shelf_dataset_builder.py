...
class kitchenScene9PutTheFryingPanOnTheCabinetShelfDatasetBuilder(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            ...
            "train": glob.glob("/mnt/arc/yygx/pkgs_baselines/LIBERO/libero/datasets/libero_90_openvla_no_noops/KITCHEN_SCENE9_put_the_frying_pan_on_the_cabinet_shelf_demo.hdf5"),
        }
