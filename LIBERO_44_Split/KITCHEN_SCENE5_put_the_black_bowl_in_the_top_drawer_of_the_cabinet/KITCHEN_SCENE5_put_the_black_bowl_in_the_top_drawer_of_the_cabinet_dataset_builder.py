...
class kitchenScene5PutTheBlackBowlInTheTopDrawerOfTheCabinetDatasetBuilder(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            ...
            "train": glob.glob("/mnt/arc/yygx/pkgs_baselines/LIBERO/libero/datasets/libero_90_openvla_no_noops/KITCHEN_SCENE5_put_the_black_bowl_in_the_top_drawer_of_the_cabinet_demo.hdf5"),
        }
