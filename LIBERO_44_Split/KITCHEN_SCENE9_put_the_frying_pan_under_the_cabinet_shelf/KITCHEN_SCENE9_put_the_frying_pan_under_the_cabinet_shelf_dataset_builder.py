...
class kitchenScene9PutTheFryingPanUnderTheCabinetShelfDatasetBuilder(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            ...
            "train": glob.glob("/mnt/arc/yygx/pkgs_baselines/LIBERO/libero/datasets/libero_90_openvla_no_noops/KITCHEN_SCENE9_put_the_frying_pan_under_the_cabinet_shelf_demo.hdf5"),
        }
