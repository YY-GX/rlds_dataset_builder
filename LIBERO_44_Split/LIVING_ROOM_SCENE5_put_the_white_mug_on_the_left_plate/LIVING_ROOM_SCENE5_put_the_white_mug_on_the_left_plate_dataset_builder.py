...
class livingRoomScene5PutTheWhiteMugOnTheLeftPlateDatasetBuilder(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            ...
            "train": glob.glob("/mnt/arc/yygx/pkgs_baselines/LIBERO/libero/datasets/libero_90_openvla_no_noops/LIVING_ROOM_SCENE5_put_the_white_mug_on_the_left_plate_demo.hdf5"),
        }
