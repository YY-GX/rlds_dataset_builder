...
class kitchenScene5PutTheBlackBowlOnTopOfTheCabinetDatasetBuilder(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            ...
            "train": glob.glob("/mnt/arc/yygx/pkgs_baselines/LIBERO/libero/datasets/libero_90_openvla_no_noops/KITCHEN_SCENE5_put_the_black_bowl_on_top_of_the_cabinet_demo.hdf5"),
        }
