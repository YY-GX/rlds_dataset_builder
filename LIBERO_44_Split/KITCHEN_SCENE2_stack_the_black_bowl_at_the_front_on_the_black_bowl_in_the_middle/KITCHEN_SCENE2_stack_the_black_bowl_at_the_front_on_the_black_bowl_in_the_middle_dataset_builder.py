...
class kitchenScene2StackTheBlackBowlAtTheFrontOnTheBlackBowlInTheMiddleDatasetBuilder(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        return {
            ...
            "train": glob.glob("/mnt/arc/yygx/pkgs_baselines/LIBERO/libero/datasets/libero_90_openvla_no_noops/KITCHEN_SCENE2_stack_the_black_bowl_at_the_front_on_the_black_bowl_in_the_middle_demo.hdf5"),
        }
